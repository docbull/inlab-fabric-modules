...
var file_peer_proto_rawDesc = []byte{
	...
	0x64, 0x10, 0x02, 0x32, 0x8c, 0x01, 0x0a, 0x0a, 0x53, 0x44, 0x4e, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x12, 0x40, 0x0a, 0x16, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x76, 0x65, 0x72, 0x6c, 0x61,
	0x79, 0x53, 0x74, 0x72, 0x75, 0x63, 0x74, 0x75, 0x72, 0x65, 0x12, 0x16, 0x2e, 0x70, 0x65, 0x65,
	0x72, 0x2e, 0x4f, 0x76, 0x65, 0x72, 0x6c, 0x61, 0x79, 0x53, 0x74, 0x72, 0x75, 0x63, 0x74, 0x75,
	0x72, 0x65, 0x1a, 0x0c, 0x2e, 0x70, 0x65, 0x65, 0x72, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x22, 0x00, 0x42, 0x17, 0x5a, 0x15, 0x69, 0x6e, 0x6c, 0x61, 0x62, 0x2d, 0x73, 0x64, 0x6e, 0x2f,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x70, 0x65, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_peer_proto_depIdxs = []int32{
	...
	4, // 5: peer.SDNService.UpdateOverlayStructure:input_type -> peer.OverlayStructure
	5, // 6: peer.SDNService.StorePeerInformation:output_type -> peer.Status
	5, // 7: peer.SDNService.UpdateOverlayStructure:output_type -> peer.Status
...
type SDNServiceClient interface {
	...
	UpdateOverlayStructure(ctx context.Context, in *OverlayStructure, opts ...grpc.CallOption) (*Status, error)
}
...
func (c *sDNServiceClient) UpdateOverlayStructure(ctx context.Context, in *OverlayStructure, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
...
type SDNServiceServer interface {
	...
	UpdateOverlayStructure(context.Context, *OverlayStructure) (*Status, error)
}
...
func (*UnimplementedSDNServiceServer) UpdateOverlayStructure(context.Context, *OverlayStructure) (*Status, error) {
...
func _SDNService_UpdateOverlayStructure_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SDNServiceServer).UpdateOverlayStructure(ctx, req.(*OverlayStructure))
	}
	return interceptor(ctx, in, info, handler)
}
