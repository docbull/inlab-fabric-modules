...
type NetworkInfo struct {
	...
	NetworkStrength  int64  `protobuf:"varint,2,opt,name=NetworkStrength,proto3" json:"NetworkStrength,omitempty"`
}
...
func (x *NetworkInfo) GetNetworkStrength() int64 {
	if x != nil {
...
var file_peer_proto_rawDesc = []byte{
	...
	0x68, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0f, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b,
